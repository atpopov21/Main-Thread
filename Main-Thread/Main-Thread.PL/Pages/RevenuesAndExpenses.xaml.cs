...
public partial class RevenuesAndExpenses : ContentPage
{
    ...
    private readonly IRevenuesAndExpensesService _revenuesAndExpensesService;
    private readonly IDispatcherTimer _timer;

    public RevenuesAndExpenses(IRevenuesAndExpensesService RevenuesAndExpensesService)
	{
        _revenuesAndExpensesService = RevenuesAndExpensesService;
        InitializeComponent();
    ...
    private void OnLanguageChanged(string language)
    {
        ...
        {
            // Page title
            PageReference.Title = "Revenues and Expenses";
        ...
        {
            // Page title
            PageReference.Title = "Приходи и разходи";
